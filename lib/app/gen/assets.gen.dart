...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/logo_completa.png
  AssetGenImage get logoCompleta =>
      const AssetGenImage('assets/images/logo_completa.png');

  /// File path: assets/images/marker-icon.png
  AssetGenImage get markerIcon =>
      const AssetGenImage('assets/images/marker-icon.png');
